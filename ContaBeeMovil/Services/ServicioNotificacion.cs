...
public class ServicioNotificacion : IServicioNotificacion
{
    public Task MostrarErrorAsync(string mensaje)
    {
        ...
        var fondo = ResolverColor(app, isDark, "LightBackground", "DarkSecondaryBackground");
        var texto = ResolverColor(app, isDark, "PrimaryText", "PrimaryTextDark");
        var borde = ResolverColor(app, isDark, "Primary", "PrimaryDark");
    ...
    public Task MostrarExitoAsync(string mensaje)
    {
        ...
        var fondo = ResolverColor(app, isDark, "Success", "SuccessDark");
        var texto = ResolverColor(app, isDark, "LightBackground", "PrimaryTextDark");
    ...
    public Task MostrarInfoAsync(string mensaje)
    {
        ...
        var fondo = ResolverColor(app, isDark, "Gray600", "Gray400");
        var texto = ResolverColor(app, isDark, "LightBackground", "PrimaryTextDark");
